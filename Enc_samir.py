...
╚══════╝╚═╝  ╚═╝╚═╝     ╚═╝╚═╝╚═╝  ╚═╝                
                                                             
 \033[43m\033[1;91m[Programmed By kazi samir] 
 \033[43m\033[1;91m[WhatsApp : ±01840261060 
 \033[43m\033[1;91m[Facebook : FOURKAN UDDIN  TANVIR
 ...
     print(yellow+'║'+cyan+'[ Author ]    '+purple+' :[kazi samir] ') 
     print(yellow+'║'+cyan+'[ Github ]    '+purple+' :[https://github.com/kazisamir4] ') 
     print(cyan+'║[Messenger] '+purple+' :[https://m.me/j/AbZo6SrsDyc26apt/]') 
     print(cyan+'║[Email]     '+purple+' :[samirKazi523@gmail.com]\n') 
     print('\n[01] Main Menu') 
     print('[02] Exit') 
 ...
         out_f.write("# Encrypted by kazi samir\n# Whatsapp 01840261060 \n# Github- https://github.com/kazisamir4\n\n"+filedata) 
     os.remove(".temp") 
 ...
         out_f.write("# Encrypted by kazi samirr\n# Whatsapp 01840261060 \n# Github- https://github.com/kazisamir4\n\n"+filedata) 
     os.remove(".temp2") 
     sprint(success + out_file + " saved in "+pwd) 
     mover(out_file) 
 ...
                 os.system('xdg-open --view https://www.facebook.com/FOURKANUDDIN123') 
                 ret=input(white+"\nENTER TO BACK > "+green) 
             main()     
    #         else: 
     #   os.system('xdg-open https://www.facebook.com/FOURKANUDDIN123') 
